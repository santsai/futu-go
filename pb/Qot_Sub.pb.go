...
type QotSubRequest struct {
	...
	Session              *Session               `protobuf:"varint,10,opt,name=session,enum=futupb.Session" json:"session,omitempty"`                            // 时段
...
func (x *QotSubRequest) GetHeader() *QotHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
const file_Qot_Sub_proto_rawDesc = "" +
	"\n" +
	"\rQot_Sub.proto\x12\x06futupb\x1a\vTypes.proto\"\xff\x03\n" +
	"\rQotSubRequest\x124\n" +
	...
	"\x06header\x18d \x01(\v2\x11.futupb.QotHeaderR\x06header\"\x10\n" +
	"\x0eQotSubResponse\"I\n" +
	...
	"\apayload\x18\x04 \x01(\v2\x16.futupb.QotSubResponseR\apayloadB\x1fZ\x1dgithub.com/santsai/futu-go/pb"
...
var file_Qot_Sub_proto_depIdxs = []int32{
	...
	8, // 4: futupb.QotSubRequest.header:type_name -> futupb.QotHeader
	0, // 5: futupb.QotSubRequest_Internal.payload:type_name -> futupb.QotSubRequest
	9, // 6: futupb.QotSubResponse_Internal.retType:type_name -> futupb.RetType
	1, // 7: futupb.QotSubResponse_Internal.payload:type_name -> futupb.QotSubResponse
