...
func (x *QotUpdateOrderBookResponse) GetOrderBookType() OrderBookType {
...
const file_Qot_UpdateOrderBook_proto_rawDesc = "" +
	"\n" +
	"\x19Qot_UpdateOrderBook.proto\x12\x06futupb\x1a\vTypes.proto\"\xdd\x03\n" +
	...
	"\rorderBookType\x18\t \x01(\x0e2\x15.futupb.OrderBookTypeR\rorderBookType\"\xd1\x01\n" +
	...
	"\apayload\x18\x04 \x01(\v2\".futupb.QotUpdateOrderBookResponseR\apayloadB\x1fZ\x1dgithub.com/santsai/futu-go/pb"
...
var file_Qot_UpdateOrderBook_proto_goTypes = []any{
	...
	(OrderBookType)(0),                          // 4: futupb.OrderBookType
...
var file_Qot_UpdateOrderBook_proto_depIdxs = []int32{
	...
	4, // 3: futupb.QotUpdateOrderBookResponse.orderBookType:type_name -> futupb.OrderBookType
	5, // 4: futupb.QotUpdateOrderBookResponse_Internal.retType:type_name -> futupb.RetType
	0, // 5: futupb.QotUpdateOrderBookResponse_Internal.payload:type_name -> futupb.QotUpdateOrderBookResponse
