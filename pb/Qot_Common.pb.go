...
const file_Qot_Common_proto_rawDesc = "" +
	...
	"\x06volume\x18\x02 \x02(\x03R\x06volume\"\x94\x01\n" +
	"\tOrderBook\x12\x14\n" +
...
var file_Qot_Common_proto_goTypes = []any{
	(QotMarket)(0),                 // 0: futupb.QotMarket
	(SecurityType)(0),              // 1: futupb.SecurityType
	(PlateSetType)(0),              // 2: futupb.PlateSetType
	(WarrantType)(0),               // 3: futupb.WarrantType
	(OptionType)(0),                // 4: futupb.OptionType
	(IndexOptionType)(0),           // 5: futupb.IndexOptionType
	(OptionAreaType)(0),            // 6: futupb.OptionAreaType
	(QotMarketState)(0),            // 7: futupb.QotMarketState
	(TradeDateMarket)(0),           // 8: futupb.TradeDateMarket
	(TradeDateType)(0),             // 9: futupb.TradeDateType
	(RehabType)(0),                 // 10: futupb.RehabType
	(KLType)(0),                    // 11: futupb.KLType
	(KLFields)(0),                  // 12: futupb.KLFields
	(SubType)(0),                   // 13: futupb.SubType
	(TickerDirection)(0),           // 14: futupb.TickerDirection
	(TickerType)(0),                // 15: futupb.TickerType
	(DarkStatus)(0),                // 16: futupb.DarkStatus
	(SecurityStatus)(0),            // 17: futupb.SecurityStatus
	(HolderCategory)(0),            // 18: futupb.HolderCategory
	(PushDataType)(0),              // 19: futupb.PushDataType
	(SortField)(0),                 // 20: futupb.SortField
	(Issuer)(0),                    // 21: futupb.Issuer
	(IpoPeriod)(0),                 // 22: futupb.IpoPeriod
	(PriceType)(0),                 // 23: futupb.PriceType
	(WarrantStatus)(0),             // 24: futupb.WarrantStatus
	(CompanyAct)(0),                // 25: futupb.CompanyAct
	...
	(*PreAfterMarketData)(nil),     // 39: futupb.PreAfterMarketData
	(*FutureBasicQotExData)(nil),   // 40: futupb.FutureBasicQotExData
	(*WarrantBasicQotExData)(nil),  // 41: futupb.WarrantBasicQotExData
	(*BasicQot)(nil),               // 42: futupb.BasicQot
	(*TimeShare)(nil),              // 43: futupb.TimeShare
	(*SecurityStaticBasic)(nil),    // 44: futupb.SecurityStaticBasic
	(*WarrantStaticExData)(nil),    // 45: futupb.WarrantStaticExData
	(*OptionStaticExData)(nil),     // 46: futupb.OptionStaticExData
	(*FutureStaticExData)(nil),     // 47: futupb.FutureStaticExData
	(*SecurityStaticInfo)(nil),     // 48: futupb.SecurityStaticInfo
	(*Broker)(nil),                 // 49: futupb.Broker
	(*Ticker)(nil),                 // 50: futupb.Ticker
	(*OrderBookDetail)(nil),        // 51: futupb.OrderBookDetail
	(*OrderBook)(nil),              // 52: futupb.OrderBook
	(*ShareHoldingChange)(nil),     // 53: futupb.ShareHoldingChange
	(*SubInfo)(nil),                // 54: futupb.SubInfo
	(*ConnSubInfo)(nil),            // 55: futupb.ConnSubInfo
	(*PlateInfo)(nil),              // 56: futupb.PlateInfo
