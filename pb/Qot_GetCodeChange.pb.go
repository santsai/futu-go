...
func (x *QotGetCodeChangeRequest) GetHeader() *QotHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
const file_Qot_GetCodeChange_proto_rawDesc = "" +
	"\n" +
	"\x17Qot_GetCodeChange.proto\x12\x06futupb\x1a\vTypes.proto\"\x84\x03\n" +
	...
	"\aendTime\x18\x03 \x01(\tR\aendTime\"\x8c\x02\n" +
	...
	"\btypeList\x18\x04 \x03(\x0e2\x16.futupb.CodeChangeTypeR\btypeList\x12)\n" +
	...
	"\x12TimeFilterType_End\x10\x03B\x1fZ\x1dgithub.com/santsai/futu-go/pb"
...
var file_Qot_GetCodeChange_proto_depIdxs = []int32{
	...
	9,  // 7: futupb.QotGetCodeChangeRequest.header:type_name -> futupb.QotHeader
	2,  // 8: futupb.QotGetCodeChangeResponse.codeChangeList:type_name -> futupb.CodeChangeInfo
	4,  // 9: futupb.QotGetCodeChangeRequest_Internal.payload:type_name -> futupb.QotGetCodeChangeRequest
	10, // 10: futupb.QotGetCodeChangeResponse_Internal.retType:type_name -> futupb.RetType
	5,  // 11: futupb.QotGetCodeChangeResponse_Internal.payload:type_name -> futupb.QotGetCodeChangeResponse
