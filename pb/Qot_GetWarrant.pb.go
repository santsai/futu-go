...
func (x *QotGetWarrantRequest) GetIpoPeriod() IpoPeriod {
	...
	return IpoPeriod_IpoPeriod_Unknown
}
...
func (x *QotGetWarrantRequest) GetStatus() WarrantStatus {
	...
	return WarrantStatus_WarrantStatus_Unknown
}
...
func (x *QotGetWarrantRequest) GetHeader() *QotHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
type WarrantData struct {
	...
	Status             *WarrantStatus `protobuf:"varint,20,req,name=status,enum=futupb.WarrantStatus" json:"status,omitempty"`                   //Qot_Common.WarrantStatus，窝轮状态
...
func (x *WarrantData) GetStatus() WarrantStatus {
	if x != nil && x.Status != nil {
		return *x.Status
	}
	return WarrantStatus_WarrantStatus_Unknown
...
const file_Qot_GetWarrant_proto_rawDesc = "" +
	"\n" +
	"\x14Qot_GetWarrant.proto\x12\x06futupb\x1a\vTypes.proto\"\xc0\n" +
	"\n" +
	...
	"\x06header\x18d \x01(\v2\x11.futupb.QotHeaderR\x06header\"\xb0\f\n" +
	"\vWarrantData\x12&\n" +
	...
	"changeRate\x12-\n" +
	"\x06status\x18\x14 \x02(\x0e2\x15.futupb.WarrantStatusR\x06status\x12\x1a\n" +
	...
	"\apayload\x18\x04 \x01(\v2\x1d.futupb.QotGetWarrantResponseR\apayloadB\x1fZ\x1dgithub.com/santsai/futu-go/pb"
...
var file_Qot_GetWarrant_proto_goTypes = []any{
	...
	(*QotHeader)(nil),                      // 12: futupb.QotHeader
...
var file_Qot_GetWarrant_proto_depIdxs = []int32{
	...
	12, // 7: futupb.QotGetWarrantRequest.header:type_name -> futupb.QotHeader
	6,  // 8: futupb.WarrantData.stock:type_name -> futupb.Security
	6,  // 9: futupb.WarrantData.owner:type_name -> futupb.Security
	7,  // 10: futupb.WarrantData.type:type_name -> futupb.WarrantType
	8,  // 11: futupb.WarrantData.issuer:type_name -> futupb.Issuer
	11, // 12: futupb.WarrantData.status:type_name -> futupb.WarrantStatus
	10, // 13: futupb.WarrantData.inLinePriceStatus:type_name -> futupb.PriceType
	1,  // 14: futupb.QotGetWarrantResponse.warrantDataList:type_name -> futupb.WarrantData
	0,  // 15: futupb.QotGetWarrantRequest_Internal.payload:type_name -> futupb.QotGetWarrantRequest
	13, // 16: futupb.QotGetWarrantResponse_Internal.retType:type_name -> futupb.RetType
	2,  // 17: futupb.QotGetWarrantResponse_Internal.payload:type_name -> futupb.QotGetWarrantResponse
