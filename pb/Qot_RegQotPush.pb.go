...
func (x *QotRegQotPushRequest) GetHeader() *QotHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
const file_Qot_RegQotPush_proto_rawDesc = "" +
	"\n" +
	"\x14Qot_RegQotPush.proto\x12\x06futupb\x1a\vTypes.proto\"\xa9\x02\n" +
	...
	"\x06header\x18d \x01(\v2\x11.futupb.QotHeaderR\x06header\"\x17\n" +
	...
	"\apayload\x18\x04 \x01(\v2\x1d.futupb.QotRegQotPushResponseR\apayloadB\x1fZ\x1dgithub.com/santsai/futu-go/pb"
...
var file_Qot_RegQotPush_proto_depIdxs = []int32{
	...
	7, // 3: futupb.QotRegQotPushRequest.header:type_name -> futupb.QotHeader
	0, // 4: futupb.QotRegQotPushRequest_Internal.payload:type_name -> futupb.QotRegQotPushRequest
	8, // 5: futupb.QotRegQotPushResponse_Internal.retType:type_name -> futupb.RetType
	1, // 6: futupb.QotRegQotPushResponse_Internal.payload:type_name -> futupb.QotRegQotPushResponse
