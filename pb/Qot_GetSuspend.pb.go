...
func (x *QotGetSuspendRequest) GetHeader() *QotHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
const file_Qot_GetSuspend_proto_rawDesc = "" +
	"\n" +
	"\x14Qot_GetSuspend.proto\x12\x06futupb\x1a\vTypes.proto\"\xaf\x01\n" +
	...
	"\apayload\x18\x04 \x01(\v2\x1d.futupb.QotGetSuspendResponseR\apayloadB\x1fZ\x1dgithub.com/santsai/futu-go/pb"
...
var file_Qot_GetSuspend_proto_depIdxs = []int32{
	...
	7, // 1: futupb.QotGetSuspendRequest.header:type_name -> futupb.QotHeader
	6, // 2: futupb.SecuritySuspend.security:type_name -> futupb.Security
	1, // 3: futupb.SecuritySuspend.suspendList:type_name -> futupb.Suspend
	2, // 4: futupb.QotGetSuspendResponse.SecuritySuspendList:type_name -> futupb.SecuritySuspend
	0, // 5: futupb.QotGetSuspendRequest_Internal.payload:type_name -> futupb.QotGetSuspendRequest
	8, // 6: futupb.QotGetSuspendResponse_Internal.retType:type_name -> futupb.RetType
	3, // 7: futupb.QotGetSuspendResponse_Internal.payload:type_name -> futupb.QotGetSuspendResponse
