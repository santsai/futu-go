...
func (x *QotRequestHistoryKLRequest) GetHeader() *QotHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
const file_Qot_RequestHistoryKL_proto_rawDesc = "" +
	"\n" +
	"\x1aQot_RequestHistoryKL.proto\x12\x06futupb\x1a\vTypes.proto\"\xc3\x03\n" +
	...
	"\asession\x18\n" +
	" \x01(\x0e2\x0f.futupb.SessionR\asession\x12)\n" +
	"\x06header\x18d \x01(\v2\x11.futupb.QotHeaderR\x06header\"\xa6\x01\n" +
	...
	"\apayload\x18\x04 \x01(\v2#.futupb.QotRequestHistoryKLResponseR\apayloadB\x1fZ\x1dgithub.com/santsai/futu-go/pb"
...
var file_Qot_RequestHistoryKL_proto_goTypes = []any{
	...
	(*QotHeader)(nil), // 8: futupb.QotHeader
...
var file_Qot_RequestHistoryKL_proto_depIdxs = []int32{
	...
	8,  // 4: futupb.QotRequestHistoryKLRequest.header:type_name -> futupb.QotHeader
	6,  // 5: futupb.QotRequestHistoryKLResponse.security:type_name -> futupb.Security
	9,  // 6: futupb.QotRequestHistoryKLResponse.klList:type_name -> futupb.KLine
	0,  // 7: futupb.QotRequestHistoryKLRequest_Internal.payload:type_name -> futupb.QotRequestHistoryKLRequest
	10, // 8: futupb.QotRequestHistoryKLResponse_Internal.retType:type_name -> futupb.RetType
	1,  // 9: futupb.QotRequestHistoryKLResponse_Internal.payload:type_name -> futupb.QotRequestHistoryKLResponse
