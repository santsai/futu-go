...
func (x *QotGetFutureInfoRequest) GetHeader() *QotHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
const file_Qot_GetFutureInfo_proto_rawDesc = "" +
	"\n" +
	"\x17Qot_GetFutureInfo.proto\x12\x06futupb\x1a\vTypes.proto\"3\n" +
	"\tTradeTime\x12\x14\n" +
	...
	"\x06origin\x18\x12 \x01(\v2\x10.futupb.SecurityR\x06origin\"z\n" +
	"\x17QotGetFutureInfoRequest\x124\n" +
	"\fsecurityList\x18\x01 \x03(\v2\x10.futupb.SecurityR\fsecurityList\x12)\n" +
	"\x06header\x18d \x01(\v2\x11.futupb.QotHeaderR\x06header\"V\n" +
	...
	"\apayload\x18\x04 \x01(\v2 .futupb.QotGetFutureInfoResponseR\apayloadB\x1fZ\x1dgithub.com/santsai/futu-go/pb"
...
var file_Qot_GetFutureInfo_proto_depIdxs = []int32{
	...
	7,  // 5: futupb.QotGetFutureInfoRequest.header:type_name -> futupb.QotHeader
	1,  // 6: futupb.QotGetFutureInfoResponse.futureInfoList:type_name -> futupb.FutureInfo
	2,  // 7: futupb.QotGetFutureInfoRequest_Internal.payload:type_name -> futupb.QotGetFutureInfoRequest
	8,  // 8: futupb.QotGetFutureInfoResponse_Internal.retType:type_name -> futupb.RetType
	3,  // 9: futupb.QotGetFutureInfoResponse_Internal.payload:type_name -> futupb.QotGetFutureInfoResponse
