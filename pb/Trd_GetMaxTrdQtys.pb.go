...
func (x *TrdGetMaxTrdQtysRequest) GetPositionID() uint64 {
...
const file_Trd_GetMaxTrdQtys_proto_rawDesc = "" +
	"\n" +
	"\x17Trd_GetMaxTrdQtys.proto\x12\x06futupb\x1a\vTypes.proto\"\xa8\x03\n" +
	...
	"\asession\x18\n" +
	" \x01(\x0e2\x0f.futupb.SessionR\asession\x12\x1e\n" +
	"\n" +
	...
	"\apayload\x18\x04 \x01(\v2 .futupb.TrdGetMaxTrdQtysResponseR\apayloadB\x1fZ\x1dgithub.com/santsai/futu-go/pb"
