...
func (x *QotGetUserSecurityGroupRequest) GetHeader() *QotHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
const file_Qot_GetUserSecurityGroup_proto_rawDesc = "" +
	"\n" +
	"\x1eQot_GetUserSecurityGroup.proto\x12\x06futupb\x1a\vTypes.proto\"|\n" +
	"\x1eQotGetUserSecurityGroupRequest\x12/\n" +
	"\tgroupType\x18\x01 \x02(\x0e2\x11.futupb.GroupTypeR\tgroupType\x12)\n" +
	...
	"\rGroupType_All\x10\x03B\x1fZ\x1dgithub.com/santsai/futu-go/pb"
...
var file_Qot_GetUserSecurityGroup_proto_depIdxs = []int32{
	...
	6, // 1: futupb.QotGetUserSecurityGroupRequest.header:type_name -> futupb.QotHeader
	0, // 2: futupb.GroupData.groupType:type_name -> futupb.GroupType
	2, // 3: futupb.QotGetUserSecurityGroupResponse.groupList:type_name -> futupb.GroupData
	1, // 4: futupb.QotGetUserSecurityGroupRequest_Internal.payload:type_name -> futupb.QotGetUserSecurityGroupRequest
	7, // 5: futupb.QotGetUserSecurityGroupResponse_Internal.retType:type_name -> futupb.RetType
	3, // 6: futupb.QotGetUserSecurityGroupResponse_Internal.payload:type_name -> futupb.QotGetUserSecurityGroupResponse
