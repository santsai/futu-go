...
func (x *QotGetHistoryKLPointsRequest) GetHeader() *QotHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
const file_Qot_GetHistoryKLPoints_proto_rawDesc = "" +
	"\n" +
	"\x1cQot_GetHistoryKLPoints.proto\x12\x06futupb\x1a\vTypes.proto\"\x82\x03\n" +
	...
	"\x0fDataStatus_Back\x10\x03B\x1fZ\x1dgithub.com/santsai/futu-go/pb"
...
var file_Qot_GetHistoryKLPoints_proto_depIdxs = []int32{
	...
	11, // 4: futupb.QotGetHistoryKLPointsRequest.header:type_name -> futupb.QotHeader
	1,  // 5: futupb.HistoryPointsKL.status:type_name -> futupb.DataStatus
	12, // 6: futupb.HistoryPointsKL.kl:type_name -> futupb.KLine
	10, // 7: futupb.SecurityHistoryKLPoints.security:type_name -> futupb.Security
	3,  // 8: futupb.SecurityHistoryKLPoints.klList:type_name -> futupb.HistoryPointsKL
	4,  // 9: futupb.QotGetHistoryKLPointsResponse.klPointList:type_name -> futupb.SecurityHistoryKLPoints
	2,  // 10: futupb.QotGetHistoryKLPointsRequest_Internal.payload:type_name -> futupb.QotGetHistoryKLPointsRequest
	13, // 11: futupb.QotGetHistoryKLPointsResponse_Internal.retType:type_name -> futupb.RetType
	5,  // 12: futupb.QotGetHistoryKLPointsResponse_Internal.payload:type_name -> futupb.QotGetHistoryKLPointsResponse
