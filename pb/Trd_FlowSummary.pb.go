...
func (x *TrdFlowSummaryRequest) GetStartCreateDate() string {
...
func (x *TrdFlowSummaryRequest) GetEndCreateDate() string {
...
const file_Trd_FlowSummary_proto_rawDesc = "" +
	"\n" +
	"\x15Trd_FlowSummary.proto\x12\x06futupb\x1a\vTypes.proto\"\x8b\x03\n" +
	...
	"\x11cashFlowDirection\x18\x03 \x01(\x0e2\x1c.futupb.TrdCashFlowDirectionR\x11cashFlowDirection\x12(\n" +
	"\x0fstartCreateDate\x18\x04 \x01(\tR\x0fstartCreateDate\x12$\n" +
	"\rendCreateDate\x18\x05 \x01(\tR\rendCreateDate\"\x8e\x01\n" +
	...
	"\x18TrdCashFlowDirection_Out\x10\x02B\x1fZ\x1dgithub.com/santsai/futu-go/pb"
