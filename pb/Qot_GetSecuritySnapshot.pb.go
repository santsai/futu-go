...
type QotGetSecuritySnapshotRequest struct {
...
func (x *QotGetSecuritySnapshotRequest) Reset() {
	*x = QotGetSecuritySnapshotRequest{}
	mi := &file_Qot_GetSecuritySnapshot_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *QotGetSecuritySnapshotRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QotGetSecuritySnapshotRequest) ProtoMessage() {}

func (x *QotGetSecuritySnapshotRequest) ProtoReflect() protoreflect.Message {
	mi := &file_Qot_GetSecuritySnapshot_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use QotGetSecuritySnapshotRequest.ProtoReflect.Descriptor instead.
func (*QotGetSecuritySnapshotRequest) Descriptor() ([]byte, []int) {
	return file_Qot_GetSecuritySnapshot_proto_rawDescGZIP(), []int{0}
}

func (x *QotGetSecuritySnapshotRequest) GetSecurityList() []*Security {
	if x != nil {
...
func (x *QotGetSecuritySnapshotRequest) GetHeader() *QotHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
type WarrantSnapshotExData struct {
	...
	WarrantType        *WarrantType           `protobuf:"varint,2,req,name=warrantType,enum=futupb.WarrantType" json:"warrantType,omitempty"`            //Qot_Common.WarrantType,窝轮类型
	...
	Owner              *Security              `protobuf:"bytes,6,req,name=owner" json:"owner,omitempty"`                                                 //所属正股
	...
	InLinePriceStatus  *PriceType             `protobuf:"varint,24,opt,name=inLinePriceStatus,enum=futupb.PriceType" json:"inLinePriceStatus,omitempty"` //Qot_Common.PriceType, 界内界外，仅界内证支持该字段
...
type OptionSnapshotExData struct {
	...
	IndexOptionType      *IndexOptionType       `protobuf:"varint,15,opt,name=indexOptionType,enum=futupb.IndexOptionType" json:"indexOptionType,omitempty"` //Qot_Common.IndexOptionType，指数期权类型
	...
	OptionAreaType       *OptionAreaType        `protobuf:"varint,20,opt,name=optionAreaType,enum=futupb.OptionAreaType" json:"optionAreaType,omitempty"`    //Qot_Common.OptionAreaType，期权类型（按行权时间）
...
type TrustSnapshotExData struct {
	...
	AssetClass       *AssetClass            `protobuf:"varint,6,req,name=assetClass,enum=futupb.AssetClass" json:"assetClass,omitempty"` //Qot_Common.AssetClass，资产类别
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type SnapshotBasicData struct {
	...
	Type                    *SecurityType          `protobuf:"varint,2,req,name=type,enum=futupb.SecurityType" json:"type,omitempty"`                //Qot_Common.SecurityType,股票类型
	...
	PreMarket               *PreAfterMarketData    `protobuf:"bytes,37,opt,name=preMarket" json:"preMarket,omitempty"`                               //Qot_Common::PreAfterMarketData 盘前数据
	AfterMarket             *PreAfterMarketData    `protobuf:"bytes,38,opt,name=afterMarket" json:"afterMarket,omitempty"`                           //Qot_Common::PreAfterMarketData 盘后数据
	SecStatus               *SecurityStatus        `protobuf:"varint,39,opt,name=secStatus,enum=futupb.SecurityStatus" json:"secStatus,omitempty"`   //Qot_Common::SecurityStatus 股票状态
	ClosePrice5Minute       *float64               `protobuf:"fixed64,40,opt,name=closePrice5Minute" json:"closePrice5Minute,omitempty"`             //5分钟收盘价
	Overnight               *PreAfterMarketData    `protobuf:"bytes,42,opt,name=overnight" json:"overnight,omitempty"`                               //Qot_Common::PreAfterMarketData 夜盘数据
...
func (x *SnapshotBasicData) GetSecStatus() SecurityStatus {
...
func (x *SnapshotBasicData) GetOvernight() *PreAfterMarketData {
	if x != nil {
		return x.Overnight
	}
	return nil
...
type QotGetSecuritySnapshotResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *QotGetSecuritySnapshotResponse) Reset() {
	*x = QotGetSecuritySnapshotResponse{}
	mi := &file_Qot_GetSecuritySnapshot_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *QotGetSecuritySnapshotResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QotGetSecuritySnapshotResponse) ProtoMessage() {}

func (x *QotGetSecuritySnapshotResponse) ProtoReflect() protoreflect.Message {
	mi := &file_Qot_GetSecuritySnapshot_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QotGetSecuritySnapshotResponse.ProtoReflect.Descriptor instead.
func (*QotGetSecuritySnapshotResponse) Descriptor() ([]byte, []int) {
	return file_Qot_GetSecuritySnapshot_proto_rawDescGZIP(), []int{10}
}

func (x *QotGetSecuritySnapshotResponse) GetSnapshotList() []*Snapshot {
	if x != nil {
...
type QotGetSecuritySnapshotRequest_Internal struct {
	state         protoimpl.MessageState         `protogen:"open.v1"`
	Payload       *QotGetSecuritySnapshotRequest `protobuf:"bytes,1,req,name=payload" json:"payload,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *QotGetSecuritySnapshotRequest_Internal) Reset() {
	*x = QotGetSecuritySnapshotRequest_Internal{}
	mi := &file_Qot_GetSecuritySnapshot_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *QotGetSecuritySnapshotRequest_Internal) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QotGetSecuritySnapshotRequest_Internal) ProtoMessage() {}

func (x *QotGetSecuritySnapshotRequest_Internal) ProtoReflect() protoreflect.Message {
	mi := &file_Qot_GetSecuritySnapshot_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QotGetSecuritySnapshotRequest_Internal.ProtoReflect.Descriptor instead.
func (*QotGetSecuritySnapshotRequest_Internal) Descriptor() ([]byte, []int) {
	return file_Qot_GetSecuritySnapshot_proto_rawDescGZIP(), []int{11}
}

func (x *QotGetSecuritySnapshotRequest_Internal) GetPayload() *QotGetSecuritySnapshotRequest {
	if x != nil {
		return x.Payload
	}
	return nil
...
type QotGetSecuritySnapshotResponse_Internal struct {
	state         protoimpl.MessageState          `protogen:"open.v1"`
	...
	Payload       *QotGetSecuritySnapshotResponse `protobuf:"bytes,4,opt,name=payload" json:"payload,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

// Default values for QotGetSecuritySnapshotResponse_Internal fields.
const (
	Default_QotGetSecuritySnapshotResponse_Internal_RetType = RetType_RetType_Unknown
)

func (x *QotGetSecuritySnapshotResponse_Internal) Reset() {
	*x = QotGetSecuritySnapshotResponse_Internal{}
	mi := &file_Qot_GetSecuritySnapshot_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *QotGetSecuritySnapshotResponse_Internal) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QotGetSecuritySnapshotResponse_Internal) ProtoMessage() {}

func (x *QotGetSecuritySnapshotResponse_Internal) ProtoReflect() protoreflect.Message {
	mi := &file_Qot_GetSecuritySnapshot_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QotGetSecuritySnapshotResponse_Internal.ProtoReflect.Descriptor instead.
func (*QotGetSecuritySnapshotResponse_Internal) Descriptor() ([]byte, []int) {
	return file_Qot_GetSecuritySnapshot_proto_rawDescGZIP(), []int{12}
}

func (x *QotGetSecuritySnapshotResponse_Internal) GetRetType() RetType {
	if x != nil && x.RetType != nil {
		return *x.RetType
	}
	return Default_QotGetSecuritySnapshotResponse_Internal_RetType
}

func (x *QotGetSecuritySnapshotResponse_Internal) GetRetMsg() string {
...
func (x *QotGetSecuritySnapshotResponse_Internal) GetErrCode() int32 {
...
func (x *QotGetSecuritySnapshotResponse_Internal) GetPayload() *QotGetSecuritySnapshotResponse {
	if x != nil {
		return x.Payload
	}
	return nil
...
const file_Qot_GetSecuritySnapshot_proto_rawDesc = "" +
	"\n" +
	"\x1dQot_GetSecuritySnapshot.proto\x12\x06futupb\x1a\vTypes.proto\"\x80\x01\n" +
	"\x1dQotGetSecuritySnapshotRequest\x124\n" +
	"\fsecurityList\x18\x01 \x03(\v2\x10.futupb.SecurityR\fsecurityList\x12)\n" +
	"\x06header\x18d \x01(\v2\x11.futupb.QotHeaderR\x06header\"\xda\x04\n" +
	...
	"\x10dividendLFYRatio\x18\x10 \x01(\x01R\x10dividendLFYRatio\"\xcf\a\n" +
	"\x15WarrantSnapshotExData\x12&\n" +
	"\x0econversionRate\x18\x01 \x02(\x01R\x0econversionRate\x125\n" +
	"\vwarrantType\x18\x02 \x02(\x0e2\x13.futupb.WarrantTypeR\vwarrantType\x12 \n" +
	...
	"\x05owner\x18\x06 \x02(\v2\x10.futupb.SecurityR\x05owner\x12$\n" +
	...
	"\x11inLinePriceStatus\x18\x18 \x01(\x0e2\x11.futupb.PriceTypeR\x11inLinePriceStatus\x12\x1e\n" +
	"\n" +
	...
	"\x0fstrikeTimestamp\x18\x0e \x01(\x01R\x0fstrikeTimestamp\x12A\n" +
	"\x0findexOptionType\x18\x0f \x01(\x0e2\x17.futupb.IndexOptionTypeR\x0findexOptionType\x12(\n" +
	...
	"\x0eoptionAreaType\x18\x14 \x01(\x0e2\x16.futupb.OptionAreaTypeR\x0eoptionAreaType\x12.\n" +
	...
	"\x0eisMainContract\x18\x06 \x02(\bR\x0eisMainContract\"\xed\x01\n" +
	...
	"\apremium\x18\x05 \x02(\x01R\apremium\x122\n" +
	"\n" +
	"assetClass\x18\x06 \x02(\x0e2\x12.futupb.AssetClassR\n" +
	"assetClass\"\xad\r\n" +
	"\x11SnapshotBasicData\x12,\n" +
	"\bsecurity\x18\x01 \x02(\v2\x10.futupb.SecurityR\bsecurity\x12\x12\n" +
	"\x04name\x18) \x01(\tR\x04name\x12(\n" +
	"\x04type\x18\x02 \x02(\x0e2\x14.futupb.SecurityTypeR\x04type\x12\x1c\n" +
	...
	"\x12lowestHistoryPrice\x18$ \x01(\x01R\x12lowestHistoryPrice\x128\n" +
	"\tpreMarket\x18% \x01(\v2\x1a.futupb.PreAfterMarketDataR\tpreMarket\x12<\n" +
	"\vafterMarket\x18& \x01(\v2\x1a.futupb.PreAfterMarketDataR\vafterMarket\x124\n" +
	"\tsecStatus\x18' \x01(\x0e2\x16.futupb.SecurityStatusR\tsecStatus\x12,\n" +
	"\x11closePrice5Minute\x18( \x01(\x01R\x11closePrice5Minute\x128\n" +
	"\tovernight\x18* \x01(\v2\x1a.futupb.PreAfterMarketDataR\tovernight\x12\x1a\n" +
	"\bhpVolume\x18+ \x01(\x01R\bhpVolume\x12\x1a\n" +
	"\bhpAskVol\x18, \x01(\x01R\bhpAskVol\x12\x1a\n" +
	"\bhpBidVol\x18- \x01(\x01R\bhpBidVol\"\x83\x04\n" +
	"\bSnapshot\x12/\n" +
	"\x05basic\x18\x01 \x02(\v2\x19.futupb.SnapshotBasicDataR\x05basic\x12@\n" +
	"\fequityExData\x18\x02 \x01(\v2\x1c.futupb.EquitySnapshotExDataR\fequityExData\x12C\n" +
	"\rwarrantExData\x18\x03 \x01(\v2\x1d.futupb.WarrantSnapshotExDataR\rwarrantExData\x12@\n" +
	"\foptionExData\x18\x04 \x01(\v2\x1c.futupb.OptionSnapshotExDataR\foptionExData\x12=\n" +
	"\vindexExData\x18\x05 \x01(\v2\x1b.futupb.IndexSnapshotExDataR\vindexExData\x12=\n" +
	"\vplateExData\x18\x06 \x01(\v2\x1b.futupb.PlateSnapshotExDataR\vplateExData\x12@\n" +
	"\ffutureExData\x18\a \x01(\v2\x1c.futupb.FutureSnapshotExDataR\ffutureExData\x12=\n" +
	"\vtrustExData\x18\b \x01(\v2\x1b.futupb.TrustSnapshotExDataR\vtrustExData\"V\n" +
	"\x1eQotGetSecuritySnapshotResponse\x124\n" +
	"\fsnapshotList\x18\x01 \x03(\v2\x10.futupb.SnapshotR\fsnapshotList\"i\n" +
	"&QotGetSecuritySnapshotRequest_Internal\x12?\n" +
	"\apayload\x18\x01 \x02(\v2%.futupb.QotGetSecuritySnapshotRequestR\apayload\"\xd9\x01\n" +
	"'QotGetSecuritySnapshotResponse_Internal\x12:\n" +
	...
	"\apayload\x18\x04 \x01(\v2&.futupb.QotGetSecuritySnapshotResponseR\apayloadB\x1fZ\x1dgithub.com/santsai/futu-go/pb"
...
var file_Qot_GetSecuritySnapshot_proto_goTypes = []any{
	(*QotGetSecuritySnapshotRequest)(nil),           // 0: futupb.QotGetSecuritySnapshotRequest
	(*EquitySnapshotExData)(nil),                    // 1: futupb.EquitySnapshotExData
	(*WarrantSnapshotExData)(nil),                   // 2: futupb.WarrantSnapshotExData
	(*OptionSnapshotExData)(nil),                    // 3: futupb.OptionSnapshotExData
	(*IndexSnapshotExData)(nil),                     // 4: futupb.IndexSnapshotExData
	(*PlateSnapshotExData)(nil),                     // 5: futupb.PlateSnapshotExData
	(*FutureSnapshotExData)(nil),                    // 6: futupb.FutureSnapshotExData
	(*TrustSnapshotExData)(nil),                     // 7: futupb.TrustSnapshotExData
	(*SnapshotBasicData)(nil),                       // 8: futupb.SnapshotBasicData
	(*Snapshot)(nil),                                // 9: futupb.Snapshot
	(*QotGetSecuritySnapshotResponse)(nil),          // 10: futupb.QotGetSecuritySnapshotResponse
	(*QotGetSecuritySnapshotRequest_Internal)(nil),  // 11: futupb.QotGetSecuritySnapshotRequest_Internal
	(*QotGetSecuritySnapshotResponse_Internal)(nil), // 12: futupb.QotGetSecuritySnapshotResponse_Internal
	(*Security)(nil),                                // 13: futupb.Security
	(*QotHeader)(nil),                               // 14: futupb.QotHeader
	(WarrantType)(0),                                // 15: futupb.WarrantType
	(PriceType)(0),                                  // 16: futupb.PriceType
	(OptionType)(0),                                 // 17: futupb.OptionType
	(IndexOptionType)(0),                            // 18: futupb.IndexOptionType
	(OptionAreaType)(0),                             // 19: futupb.OptionAreaType
	(AssetClass)(0),                                 // 20: futupb.AssetClass
	(SecurityType)(0),                               // 21: futupb.SecurityType
	(*PreAfterMarketData)(nil),                      // 22: futupb.PreAfterMarketData
	(SecurityStatus)(0),                             // 23: futupb.SecurityStatus
	(RetType)(0),                                    // 24: futupb.RetType
}
var file_Qot_GetSecuritySnapshot_proto_depIdxs = []int32{
	13, // 0: futupb.QotGetSecuritySnapshotRequest.securityList:type_name -> futupb.Security
	14, // 1: futupb.QotGetSecuritySnapshotRequest.header:type_name -> futupb.QotHeader
	15, // 2: futupb.WarrantSnapshotExData.warrantType:type_name -> futupb.WarrantType
	13, // 3: futupb.WarrantSnapshotExData.owner:type_name -> futupb.Security
	16, // 4: futupb.WarrantSnapshotExData.inLinePriceStatus:type_name -> futupb.PriceType
	17, // 5: futupb.OptionSnapshotExData.type:type_name -> futupb.OptionType
	13, // 6: futupb.OptionSnapshotExData.owner:type_name -> futupb.Security
	18, // 7: futupb.OptionSnapshotExData.indexOptionType:type_name -> futupb.IndexOptionType
	19, // 8: futupb.OptionSnapshotExData.optionAreaType:type_name -> futupb.OptionAreaType
	20, // 9: futupb.TrustSnapshotExData.assetClass:type_name -> futupb.AssetClass
	13, // 10: futupb.SnapshotBasicData.security:type_name -> futupb.Security
	21, // 11: futupb.SnapshotBasicData.type:type_name -> futupb.SecurityType
	22, // 12: futupb.SnapshotBasicData.preMarket:type_name -> futupb.PreAfterMarketData
	22, // 13: futupb.SnapshotBasicData.afterMarket:type_name -> futupb.PreAfterMarketData
	23, // 14: futupb.SnapshotBasicData.secStatus:type_name -> futupb.SecurityStatus
	22, // 15: futupb.SnapshotBasicData.overnight:type_name -> futupb.PreAfterMarketData
	8,  // 16: futupb.Snapshot.basic:type_name -> futupb.SnapshotBasicData
	1,  // 17: futupb.Snapshot.equityExData:type_name -> futupb.EquitySnapshotExData
	2,  // 18: futupb.Snapshot.warrantExData:type_name -> futupb.WarrantSnapshotExData
	3,  // 19: futupb.Snapshot.optionExData:type_name -> futupb.OptionSnapshotExData
	4,  // 20: futupb.Snapshot.indexExData:type_name -> futupb.IndexSnapshotExData
	5,  // 21: futupb.Snapshot.plateExData:type_name -> futupb.PlateSnapshotExData
	6,  // 22: futupb.Snapshot.futureExData:type_name -> futupb.FutureSnapshotExData
	7,  // 23: futupb.Snapshot.trustExData:type_name -> futupb.TrustSnapshotExData
	9,  // 24: futupb.QotGetSecuritySnapshotResponse.snapshotList:type_name -> futupb.Snapshot
	0,  // 25: futupb.QotGetSecuritySnapshotRequest_Internal.payload:type_name -> futupb.QotGetSecuritySnapshotRequest
	24, // 26: futupb.QotGetSecuritySnapshotResponse_Internal.retType:type_name -> futupb.RetType
	10, // 27: futupb.QotGetSecuritySnapshotResponse_Internal.payload:type_name -> futupb.QotGetSecuritySnapshotResponse
