...
func (x *QotModifyUserSecurityRequest) GetHeader() *QotHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
const file_Qot_ModifyUserSecurity_proto_rawDesc = "" +
	"\n" +
	"\x1cQot_ModifyUserSecurity.proto\x12\x06futupb\x1a\vTypes.proto\"\xcb\x01\n" +
	...
	"\x06header\x18d \x01(\v2\x11.futupb.QotHeaderR\x06header\"\x1f\n" +
	...
	"\x1cModifyUserSecurityOp_MoveOut\x10\x03B\x1fZ\x1dgithub.com/santsai/futu-go/pb"
...
var file_Qot_ModifyUserSecurity_proto_depIdxs = []int32{
	...
	6, // 2: futupb.QotModifyUserSecurityRequest.header:type_name -> futupb.QotHeader
	1, // 3: futupb.QotModifyUserSecurityRequest_Internal.payload:type_name -> futupb.QotModifyUserSecurityRequest
	7, // 4: futupb.QotModifyUserSecurityResponse_Internal.retType:type_name -> futupb.RetType
	2, // 5: futupb.QotModifyUserSecurityResponse_Internal.payload:type_name -> futupb.QotModifyUserSecurityResponse
