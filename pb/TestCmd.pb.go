...
func (x *TestCmdRequest) GetParamStr() string {
...
func (x *TestCmdRequest) GetParamBytes() []byte {
	if x != nil {
		return x.ParamBytes
	}
	return nil
...
func (x *TestCmdResponse) GetResultStr() string {
...
func (x *TestCmdResponse) GetResultBytes() []byte {
	if x != nil {
...
const file_TestCmd_proto_rawDesc = "" +
	"\n" +
	"\rTestCmd.proto\x12\x06futupb\x1a\vTypes.proto\"^\n" +
	...
	"\vresultBytes\x18\x03 \x01(\fR\vresultBytes\"K\n" +
	...
	"\apayload\x18\x04 \x01(\v2\x17.futupb.TestCmdResponseR\apayloadB\x1fZ\x1dgithub.com/santsai/futu-go/pb"
