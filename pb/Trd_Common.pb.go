...
const file_Trd_Common_proto_rawDesc = "" +
	...
	"\tjpAccType\x18\x04 \x01(\x0e2\x15.futupb.TrdSubAccTypeR\tjpAccType\"\xf4\x03\n" +
	"\x06TrdAcc\x12&\n" +
	"\x06trdEnv\x18\x01 \x02(\x0e2\x0e.futupb.TrdEnvR\x06trdEnv\x12\x14\n" +
	"\x05accID\x18\x02 \x02(\x04R\x05accID\x12?\n" +
	...
	"\tjpAccType\x18\v \x03(\x0e2\x15.futupb.TrdSubAccTypeR\tjpAccType\"\xd6\t\n" +
	"\x05Funds\x12\x14\n" +
	...
	"\x0eaveragePlRatio\x18\" \x01(\x01R\x0eaveragePlRatio\"\x8d\b\n" +
	"\x05Order\x12)\n" +
	...
	"\tjpAccType\x18\x1c \x01(\x0e2\x15.futupb.TrdSubAccTypeR\tjpAccType\":\n" +
	...
	"\x13TrdAssetCategory_US\x10\x02B4\n" +
...
var file_Trd_Common_proto_goTypes = []any{
	...
	(TrdSubAccType)(0),          // 21: futupb.TrdSubAccType
	(TrdAssetCategory)(0),       // 22: futupb.TrdAssetCategory
	(*AccCashInfo)(nil),         // 23: futupb.AccCashInfo
	(*AccMarketInfo)(nil),       // 24: futupb.AccMarketInfo
	(*TrdHeader)(nil),           // 25: futupb.TrdHeader
	(*TrdAcc)(nil),              // 26: futupb.TrdAcc
	(*Funds)(nil),               // 27: futupb.Funds
	(*Position)(nil),            // 28: futupb.Position
	(*Order)(nil),               // 29: futupb.Order
	(*OrderFeeItem)(nil),        // 30: futupb.OrderFeeItem
	(*OrderFee)(nil),            // 31: futupb.OrderFee
	(*OrderFill)(nil),           // 32: futupb.OrderFill
	(*MaxTrdQtys)(nil),          // 33: futupb.MaxTrdQtys
	(*TrdFilterConditions)(nil), // 34: futupb.TrdFilterConditions
	(Session)(0),                // 35: futupb.Session
}
var file_Trd_Common_proto_depIdxs = []int32{
	...
	21, // 4: futupb.TrdHeader.jpAccType:type_name -> futupb.TrdSubAccType
	0,  // 5: futupb.TrdAcc.trdEnv:type_name -> futupb.TrdEnv
	2,  // 6: futupb.TrdAcc.trdMarketAuthList:type_name -> futupb.TrdMarket
	11, // 7: futupb.TrdAcc.accType:type_name -> futupb.TrdAccType
	17, // 8: futupb.TrdAcc.securityFirm:type_name -> futupb.SecurityFirm
	18, // 9: futupb.TrdAcc.simAccType:type_name -> futupb.SimAccType
	12, // 10: futupb.TrdAcc.accStatus:type_name -> futupb.TrdAccStatus
	13, // 11: futupb.TrdAcc.accRole:type_name -> futupb.TrdAccRole
	21, // 12: futupb.TrdAcc.jpAccType:type_name -> futupb.TrdSubAccType
	14, // 13: futupb.Funds.currency:type_name -> futupb.Currency
	15, // 14: futupb.Funds.riskLevel:type_name -> futupb.CltRiskLevel
	23, // 15: futupb.Funds.cashInfoList:type_name -> futupb.AccCashInfo
	19, // 16: futupb.Funds.riskStatus:type_name -> futupb.CltRiskStatus
	20, // 17: futupb.Funds.dtStatus:type_name -> futupb.DTStatus
	24, // 18: futupb.Funds.marketInfoList:type_name -> futupb.AccMarketInfo
	9,  // 19: futupb.Position.positionSide:type_name -> futupb.PositionSide
	3,  // 20: futupb.Position.secMarket:type_name -> futupb.TrdSecMarket
	14, // 21: futupb.Position.currency:type_name -> futupb.Currency
	2,  // 22: futupb.Position.trdMarket:type_name -> futupb.TrdMarket
	4,  // 23: futupb.Order.trdSide:type_name -> futupb.TrdSide
	5,  // 24: futupb.Order.orderType:type_name -> futupb.OrderType
	7,  // 25: futupb.Order.orderStatus:type_name -> futupb.OrderStatus
	3,  // 26: futupb.Order.secMarket:type_name -> futupb.TrdSecMarket
	16, // 27: futupb.Order.timeInForce:type_name -> futupb.TimeInForce
	6,  // 28: futupb.Order.trailType:type_name -> futupb.TrailType
	14, // 29: futupb.Order.currency:type_name -> futupb.Currency
	2,  // 30: futupb.Order.trdMarket:type_name -> futupb.TrdMarket
	35, // 31: futupb.Order.session:type_name -> futupb.Session
	21, // 32: futupb.Order.jpAccType:type_name -> futupb.TrdSubAccType
	30, // 33: futupb.OrderFee.feeList:type_name -> futupb.OrderFeeItem
	4,  // 34: futupb.OrderFill.trdSide:type_name -> futupb.TrdSide
	3,  // 35: futupb.OrderFill.secMarket:type_name -> futupb.TrdSecMarket
	8,  // 36: futupb.OrderFill.status:type_name -> futupb.OrderFillStatus
	2,  // 37: futupb.OrderFill.trdMarket:type_name -> futupb.TrdMarket
	21, // 38: futupb.OrderFill.jpAccType:type_name -> futupb.TrdSubAccType
	35, // 39: futupb.MaxTrdQtys.session:type_name -> futupb.Session
	2,  // 40: futupb.TrdFilterConditions.filterMarket:type_name -> futupb.TrdMarket
