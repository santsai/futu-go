...
func (x *QotGetMarketStateRequest) GetHeader() *QotHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
const file_Qot_GetMarketState_proto_rawDesc = "" +
	"\n" +
	"\x18Qot_GetMarketState.proto\x12\x06futupb\x1a\vTypes.proto\"{\n" +
	...
	"\apayload\x18\x04 \x01(\v2!.futupb.QotGetMarketStateResponseR\apayloadB\x1fZ\x1dgithub.com/santsai/futu-go/pb"
...
var file_Qot_GetMarketState_proto_goTypes = []any{
	...
	(QotMarketState)(0),                        // 7: futupb.QotMarketState
...
var file_Qot_GetMarketState_proto_depIdxs = []int32{
	...
	6, // 1: futupb.QotGetMarketStateRequest.header:type_name -> futupb.QotHeader
	5, // 2: futupb.MarketInfo.security:type_name -> futupb.Security
	7, // 3: futupb.MarketInfo.marketState:type_name -> futupb.QotMarketState
	1, // 4: futupb.QotGetMarketStateResponse.marketInfoList:type_name -> futupb.MarketInfo
	0, // 5: futupb.QotGetMarketStateRequest_Internal.payload:type_name -> futupb.QotGetMarketStateRequest
	8, // 6: futupb.QotGetMarketStateResponse_Internal.retType:type_name -> futupb.RetType
	2, // 7: futupb.QotGetMarketStateResponse_Internal.payload:type_name -> futupb.QotGetMarketStateResponse
