...
func (x *QotGetKLRequest) GetHeader() *QotHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
const file_Qot_GetKL_proto_rawDesc = "" +
	"\n" +
	"\x0fQot_GetKL.proto\x12\x06futupb\x1a\vTypes.proto\"\xdb\x01\n" +
	...
	"\apayload\x18\x04 \x01(\v2\x18.futupb.QotGetKLResponseR\apayloadB\x1fZ\x1dgithub.com/santsai/futu-go/pb"
...
var file_Qot_GetKL_proto_depIdxs = []int32{
	...
	7, // 3: futupb.QotGetKLRequest.header:type_name -> futupb.QotHeader
	6, // 4: futupb.QotGetKLResponse.security:type_name -> futupb.Security
	8, // 5: futupb.QotGetKLResponse.klList:type_name -> futupb.KLine
	0, // 6: futupb.QotGetKLRequest_Internal.payload:type_name -> futupb.QotGetKLRequest
	9, // 7: futupb.QotGetKLResponse_Internal.retType:type_name -> futupb.RetType
	1, // 8: futupb.QotGetKLResponse_Internal.payload:type_name -> futupb.QotGetKLResponse
