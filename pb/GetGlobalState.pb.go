...
type GetGlobalStateResponse struct {
	...
	MarketSG       *QotMarketState        `protobuf:"varint,19,opt,name=marketSG,enum=futupb.QotMarketState" json:"marketSG,omitempty"`             //Qot_Common.QotMarketState,新加坡市场状态
	MarketMY       *QotMarketState        `protobuf:"varint,20,opt,name=marketMY,enum=futupb.QotMarketState" json:"marketMY,omitempty"`             //Qot_Common.QotMarketState,马来西亚市场状态
	MarketJP       *QotMarketState        `protobuf:"varint,21,opt,name=marketJP,enum=futupb.QotMarketState" json:"marketJP,omitempty"`             //Qot_Common.QotMarketState,日本市场状态
...
func (x *GetGlobalStateResponse) GetMarketSG() QotMarketState {
...
func (x *GetGlobalStateResponse) GetMarketMY() QotMarketState {
...
func (x *GetGlobalStateResponse) GetMarketJP() QotMarketState {
...
const file_GetGlobalState_proto_rawDesc = "" +
	"\n" +
	"\x14GetGlobalState.proto\x12\x06futupb\x1a\vTypes.proto\"/\n" +
	"\x15GetGlobalStateRequest\x12\x16\n" +
	"\x06userID\x18\x01 \x02(\x04R\x06userID\"\xd7\a\n" +
	...
	"\x0emarketJPFuture\x18\x12 \x01(\x0e2\x16.futupb.QotMarketStateR\x0emarketJPFuture\x122\n" +
	"\bmarketSG\x18\x13 \x01(\x0e2\x16.futupb.QotMarketStateR\bmarketSG\x122\n" +
	"\bmarketMY\x18\x14 \x01(\x0e2\x16.futupb.QotMarketStateR\bmarketMY\x122\n" +
	"\bmarketJP\x18\x15 \x01(\x0e2\x16.futupb.QotMarketStateR\bmarketJP\x12\x1e\n" +
	"\n" +
	...
	"\apayload\x18\x04 \x01(\v2\x1e.futupb.GetGlobalStateResponseR\apayloadB\x1fZ\x1dgithub.com/santsai/futu-go/pb"
...
var file_GetGlobalState_proto_depIdxs = []int32{
	...
	4,  // 8: futupb.GetGlobalStateResponse.marketSG:type_name -> futupb.QotMarketState
	4,  // 9: futupb.GetGlobalStateResponse.marketMY:type_name -> futupb.QotMarketState
	4,  // 10: futupb.GetGlobalStateResponse.marketJP:type_name -> futupb.QotMarketState
	5,  // 11: futupb.GetGlobalStateResponse.programStatus:type_name -> futupb.ProgramStatus
	0,  // 12: futupb.GetGlobalStateRequest_Internal.payload:type_name -> futupb.GetGlobalStateRequest
	6,  // 13: futupb.GetGlobalStateResponse_Internal.retType:type_name -> futupb.RetType
	1,  // 14: futupb.GetGlobalStateResponse_Internal.payload:type_name -> futupb.GetGlobalStateResponse
