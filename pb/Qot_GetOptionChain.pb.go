...
func (x *QotGetOptionChainRequest) GetHeader() *QotHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
const file_Qot_GetOptionChain_proto_rawDesc = "" +
	"\n" +
	"\x18Qot_GetOptionChain.proto\x12\x06futupb\x1a\vTypes.proto\"\xe4\x04\n" +
	"\n" +
	"DataFilter\x122\n" +
	...
	"\x06volMax\x18\x12 \x01(\x01R\x06volMax\"\xfa\x02\n" +
	...
	"dataFilter\x12)\n" +
	"\x06header\x18d \x01(\v2\x11.futupb.QotHeaderR\x06header\"j\n" +
	"\n" +
	"OptionItem\x12.\n" +
	...
	"\x16OptionCondType_Outside\x10\x02B\x1fZ\x1dgithub.com/santsai/futu-go/pb"
...
var file_Qot_GetOptionChain_proto_goTypes = []any{
	...
	(*SecurityStaticInfo)(nil),                 // 12: futupb.SecurityStaticInfo
...
var file_Qot_GetOptionChain_proto_depIdxs = []int32{
	...
	11, // 5: futupb.QotGetOptionChainRequest.header:type_name -> futupb.QotHeader
	12, // 6: futupb.OptionItem.call:type_name -> futupb.SecurityStaticInfo
	12, // 7: futupb.OptionItem.put:type_name -> futupb.SecurityStaticInfo
	3,  // 8: futupb.OptionChain.option:type_name -> futupb.OptionItem
	4,  // 9: futupb.QotGetOptionChainResponse.optionChain:type_name -> futupb.OptionChain
	2,  // 10: futupb.QotGetOptionChainRequest_Internal.payload:type_name -> futupb.QotGetOptionChainRequest
	13, // 11: futupb.QotGetOptionChainResponse_Internal.retType:type_name -> futupb.RetType
	5,  // 12: futupb.QotGetOptionChainResponse_Internal.payload:type_name -> futupb.QotGetOptionChainResponse
