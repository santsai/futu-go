...
func (x *QotGetReferenceRequest) GetHeader() *QotHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
const file_Qot_GetReference_proto_rawDesc = "" +
	"\n" +
	"\x16Qot_GetReference.proto\x12\x06futupb\x1a\vTypes.proto\"\xae\x01\n" +
	"\x16QotGetReferenceRequest\x12,\n" +
	"\bsecurity\x18\x01 \x02(\v2\x10.futupb.SecurityR\bsecurity\x12;\n" +
	"\rreferenceType\x18\x02 \x02(\x0e2\x15.futupb.ReferenceTypeR\rreferenceType\x12)\n" +
	...
	"\x14ReferenceType_Future\x10\x02B\x1fZ\x1dgithub.com/santsai/futu-go/pb"
...
var file_Qot_GetReference_proto_depIdxs = []int32{
	...
	6, // 2: futupb.QotGetReferenceRequest.header:type_name -> futupb.QotHeader
	7, // 3: futupb.QotGetReferenceResponse.staticInfoList:type_name -> futupb.SecurityStaticInfo
	1, // 4: futupb.QotGetReferenceRequest_Internal.payload:type_name -> futupb.QotGetReferenceRequest
	8, // 5: futupb.QotGetReferenceResponse_Internal.retType:type_name -> futupb.RetType
	2, // 6: futupb.QotGetReferenceResponse_Internal.payload:type_name -> futupb.QotGetReferenceResponse
